    ...
    while($rows=mysqli_fetch_assoc($query)){
        echo "<tr class='bg-white divide-y divide-gray-200'>";
            ...
            echo "<td class='px-6 py-4 whitespace-nowrap'>
                ...
                <a href='delete_activity.php?id=".$rows['id_activite']."'><button class='ml-2 px-4 py-2 font-medium text-white bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:shadow-outline-red active:bg-red-600 transition duration-150 ease-in-out'>Delete</button></a>
                </td>";
        echo "</tr>";
    }
